...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form method="GET" action="../assets/CRUD/insertCategory.php">
      ...
      <div class="input-field">
        ...
        <input type="text" id="category-code" name="codigo" class="input-text" />
        
      </div>
      <div class="actions-form">
        <a href="categories.php" class="action back">Back</a>
        <input class="btn-submit btn-action" name="submit" type="submit" value="Save"/>
      </div>
    </form>
  </main>
  <!-- Main Content -->
